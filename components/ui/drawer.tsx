    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          direction === "right" && "right-0 w-screen max-w-md top-0 h-full text-right",
          direction === "left" && "left-0 w-screen max-w-md top-0 h-full text-left",
      ...
      >
        ...
        {children}
        {(direction === "top") && (
          <div className="mx-auto mb-4 h-2 w-[100px] rounded-full bg-gray-100" />
        )}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
